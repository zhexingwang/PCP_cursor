...
from evaluate_model_accuracy_v3 import metrics_at_obs, plot_adsorption_profile_gif, plot_overlay_sparse
...
from parameter_fitting_v3 import apply_fitted_vector, load_fitted_vector
...
def main():
    ap = argparse.ArgumentParser(description="3-column chain prediction (v3)")
    ...
    ap.add_argument("--plot_new_species", action="store_true", help="(v4 compat; ignored in v3)")
    args = ap.parse_args()
    ...
    for bid in batch_ids:
        ...
        _plot_chain_overlay(results_by_col, ["VE1", "VE2", "FA"], batch_dir / "chain_overlay.png", cin)
        try:
